...
function addEmployee() {
  ...
  function addEmployeeToTable(employee) {
    ...
    let checkboxAcc = document.createElement("input");
    checkboxAcc.setAttribute("class", "checboxAcc");
    checkboxAcc.setAttribute("type", "checkbox");
    checkboxAcc.setAttribute("value", employee.account);
    tdCheckbox.appendChild(checkboxAcc);
    ...
    account.setAttribute("class", "listAcc");
    console.log(newRow);
    ...
    newRow.appendChild(tdDele);

    // Thêm hàng vào tbody
    const tbody = document.getElementById("tableDanhSach");
    tbody.appendChild(newRow);
    newRow.setAttribute("class", "listEm");
  }
